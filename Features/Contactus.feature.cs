...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Fill contact Us Form and Send a message", new string[] {
                "mytag"}, SourceLine=4)]
        public virtual void FillContactUsFormAndSendAMessage()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Fill contact Us Form and Send a message", null, new string[] {
                        "mytag"});
#line 5
...
#line 7
 testRunner.When("I select Contactus", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 8
